...
<section class="content aboutus">
    ...
    <form action="http://fruccola.hu/admin/api/add-happiness-subscriber" method="post" role="form" id="subscribe">
        ...
        <p>Please enter the name and email address of the cards's recipient, and select the fruccola where the card will be used.</p>
        <p>In case the recipient is You, please enter your own data.</p>

        <label for="firstname" class="col-sm-2 control-label">First name of the recipient:
            <input type="text" class="form-control" id="firstname" name="firstname" value="">
        </label>

        <label for="surname" class="col-sm-2 control-label">Surname of the recipient:
            <input type="text" class="form-control" id="surname" name="surname" value="">
        </label>

        <label for="email" class="col-sm-2 control-label">Email address of the recipient:
            <input type="email" class="form-control" id="email" name="email" value="">
        </label>

        <label for="amount_huf" class="col-sm-2 control-label">Credited amount (HUF):
